...
export default function StudentPortalFooter() {
  ...
  return (
    <footer className="w-full max-w-4xl mx-auto border-t border-slate-800/80 mt-12 pt-8 pb-6 text-slate-400 text-xs print:hidden">
      <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-1.5">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg bg-emerald-600 flex items-center justify-center font-black text-white text-xs shadow-md shadow-emerald-950 flex-shrink-0">
              LA
            </div>
        ...
        <div className="flex flex-col items-center md:items-end text-center md:text-right space-y-3">
          <div className="flex items-center gap-3 bg-slate-900/60 border border-slate-800/80 rounded-xl px-3.5 py-2">
            <span className="text-slate-400 text-[11px] font-medium">Need help?</span>
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 bg-emerald-950/80 hover:bg-emerald-900/90 text-emerald-300 border border-emerald-700/60 hover:border-emerald-500 px-3 py-1.5 rounded-lg text-[11px] font-semibold transition-all shadow-sm group"
            >
